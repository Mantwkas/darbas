...
//-------------------------------------POST(new user register) (i serveri talpinamos registracijos)----------------------------------------------------------------------------------------------//
...
server.post("/user/register", async (req, res )=> { // /register endopinte gausime vartotojo registracijos parametrus. gausime req.body - objektas grazinamas kai siunciami is kliento duomeny serveriui 
...
//--------------------------------GET (imama info is serverio (users array/data file) apie regist.users)------------------------------------------------------------------------------------------//
//8. Get all users in database. Kad pamatyti uzregistruotus vartotojus sukuriamas endpoint: 
...
//--------------------------------GET (Gaunamas vartotoja pagal id)------------------------------------------------------------------------------------------//
// 9. Jei yra gaunami duomenys, juos reiketu validuoti ir taip klinetui bus nusakoma kas ne taip su jo duomenim
...
//-------------------------------------POST (login) (Existing user login endpoint)----------------------------------------------------------------------------------------------//
...
//-------------------------------------GET (gauti/perskaityti visus "todo")--------------------------------------------------------------------------------------------------------------// 
server.get("/todos", (req, res) => { 
    res.status(200).json(data.todos);  //grazinamas todo listas is "const todos = []; ")
})

//-------------------------------------GET (gauti/perskaityti konkretu "todo")--------------------------------------------------------------------------------------------------------------//

//perskaityti/gauti tam tikra todo pagal id (paieska is saraso "todos = []/data file" per visus elementus)
