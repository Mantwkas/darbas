...
async function addNewTodo () {  //turi buti kreipiamasi i serveri (api.js) ir gaunamas todo  atsakymas is serverio
    ...
    const newTodo = `   
    <div todo-id="${newTodoObject.id}" class="todo d-flex justify-content-between draggable" draggable="true">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu drop-color">
          <li><a class="dropdown-item todomove" todomove="${newTodoObject.id}" href="#">Done</a></li>
          <li><a class="dropdown-item tododelete" tododelete="${newTodoObject.id}" href="#">Delete</a></li>
          <li><a class="dropdown-item todoupdate" todoupdate="${newTodoObject.id}" href="#">Update</a></li>
        </ul> 
      </div>
</div>`;
    ...
    for (const todo of todos) {
        ...
        <span class="todo-text">${todo.todo}</span> 
            ...
            <div class="dropdown">
                <i class= "bi bi-chevron-bar-down" data-bs-toggle="dropdown" aria-expanded="false"></i>
                <ul class="dropdown-menu drop-color">
                <li><a class="dropdown-item todomove" todomove="${todo.id}" href="#">Move Back</a></li>
                <li><a class="dropdown-item tododelete" tododelete="${todo.id}" href="#">Delete</a></li>
                <li><a class="dropdown-item todoupdate" todoupdate="${todo.id}" href="#">Update</a></li>
                </ul> 
            </div>
